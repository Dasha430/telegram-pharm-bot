...
public class FindMedicineService {
    ...
    public FindMedicineService(MedsInPharmacyRepository repo, MapService mapService, MedicineRepository medsRepo) {
        this.repo = repo;
    ...
    private String convertToGeocode(String address) {
        ...
        return "lng:" + result.get("lng") + " lat:" + result.get("lat");
    }
